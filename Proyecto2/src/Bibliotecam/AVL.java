...
//      public void comprobarISBN(Node r, int isbn){
//            if(r != null){
//             comprobarISBN(r.left,isbn);            
//             comprobarISBN(r.right,isbn);   
//             if(r.value.getArbol().getRaiz() != null){
//                    if (r.value.getArbol().Check(isbn)){
//                   // no se inserta porque el isbn del libro ya existe
//                    LibroEsta = true;
//                }   
//             }
//       
...
//      public boolean EstaNuevo(Node r, int isbn){
//         boolean esta = false;
//         comprobarISBN(r, isbn);
//         if (LibroEsta){
//          esta = true;
//          LibroEsta = false;
//          
...
//      public void EncontrarLibros(Node r, int carnet){
//            if(r != null){
//             EncontrarLibros(r.left,carnet);            
//             EncontrarLibros(r.right,carnet);   
//             if(r.value.getArbol().getRaiz() != null){
//                  r.value.getArbol().recorrer(r.value.getArbol().getRaiz(), carnet);
//             }
//            
//         }
//      
...
//      
//      
//       public void EncontrarCategoria(Node r, String categoria){
//            if(r != null){
//             EncontrarCategoria(r.left,categoria);            
//            EncontrarCategoria(r.right,categoria);  
//            if(r.value.getNombre().compareTo(categoria)==0 || categoria.compareTo("Todos")==0){
//               if(r.value.getArbol().getRaiz() != null){
//                   // imprimir todos los libros de esa categoria
//                   r.value.getArbol().ObtenerTodos(r.value.getArbol().getRaiz());
//              }
//            }
//
//            
...
//      }
//      
//      public void obtenerTodas(Node r){
//          
//             if(r != null){
//             obtenerTodas(r.left);            
//             obtenerTodas(r.right);   
//             todascategorias.add(r.value.getNombre());
//         }
//          
//      }
//      
//      
//           public void BorrarLibro(Node r, int isbn, String cat){
//            if(r != null){
//             BorrarLibro(r.left,isbn,cat);            
//             BorrarLibro(r.right,isbn,cat);    
//             if(r.value.getNombre().compareTo(cat)== 0){
//                 r.value.getArbol().Remove(isbn);
//                 
//             }
//             
//         }
...
//      }
        ...
        public void InsertarLibro(Node r,String cat, Libro n){
//           comprobarISBN(r,n.getISBN());
           if(LibroEsta){
            JOptionPane.showMessageDialog(null, "Libro no insertado \n"
                                               + "ISBN: "+n.getISBN()+"ya existe.");
            LibroEsta = false;
           }else{
                InsertarLibro2( r,cat, n);
            
           }
         }
        
        
       public void InsertarLibro2(Node r,String cat, Libro n){
       
         if(r != null){
             InsertarLibro2(r.left,cat,n);            
             InsertarLibro2(r.right,cat,n);
             if(r.value.getNombre().compareTo(cat) == 0){ 
//                   r.value.getArbol().Add(n.getISBN(), n);
             }
